...
- torus (spherical polar 100$0 \leq \theta \leq \pi, 0\leq \phi\leq 2\pi$)
...
- isolated points
- "shallow" points in the closure of an interval $\subset K^c$ but (not isolated)
- "deep" points

#


200$\frac{1}{1 + e^{\ell_\gamma}}=\frac{1}{2}$

is the (twice) the length of an interval in 200$K^c$ 
...
200$x \in K, \gamma_x$ the geodesic "accumulates" somewhere.
...
- 200$\gamma_x$ returns to pseudo sphere <=> isolated point 
- 200$\gamma_x$ spirals to a closed geodesic <=> "shallow" points
