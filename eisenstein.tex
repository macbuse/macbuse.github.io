...
%  \begin{figure}[b]
%\begin{center}
%\includegraphics[scale=.5]{three.png} 
%\end{center}
%\caption{Lift of an immersed  ideal triangle in grey
%with 4 triangles from the Farey tesselation.
%Its barycenter is  $1/3(1 + \omega)$ which 
%coincides with the barycenter of $0,1/2,1$ from the Farey tesselation.}
%\end{figure}
...
Recall that the 
curvature of a euclidean circle is the reciprocal of the square of its radius.}%needs checking
\end{figure}
