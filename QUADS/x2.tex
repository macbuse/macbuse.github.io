...
Amusingly one can characterise loops using $\lambda$-lengths.
\begin{lem}
...
\subsection{Counting points in $\Gamma$ orbits}
...
in the fundamental strip at height $\frac{m}{n}$.
\end{lem}


\subsection{Counting points/arcs on surfaces}
